	...
	switch (telemetry_counter)
	{
		...
		case 4:
			serial_output("F5:YAWKP_A=%5.3f:YAWKD_A=%5.3f:ROLLKP=%5.3f:ROLLKD=%5.3f:A_BOOST=%3.1f:\r\n",
			    MAXIMUM_LATERAL_ACCELERATION , YAWKD_AILERON, ROLLKP, ROLLKD, 0.0 );
			// TODO: yawkp and aileron boost no longer used, max acceleration is substituted for yawkp in telemetry
			break;
		case 3:
...
//				    locationErrorEarth[0], locationErrorEarth[1], locationErrorEarth[2], 
				    MPUtemperature, locationErrorEarth[1], locationErrorEarth[2], 
