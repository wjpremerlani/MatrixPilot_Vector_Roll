...
#define FIXED_ORIGIN_LOCATION	{ -1219950467, 374124664, 140.0 }	// A point in Baylands Park in Sunnyvale, CA
...
const struct waypointDef waypoints[] = {
	    { {   0,   20000, 140 } , F_NORMAL, CAM_VIEW_LAUNCH } ,  // return to, and loiter 75 meters above the startup position
};
...
const struct waypointDef rtlWaypoints[] = {
		{ { 0, 20000,  140 } , F_LOITER + F_LAND, CAM_VIEW_LAUNCH } ,
};
