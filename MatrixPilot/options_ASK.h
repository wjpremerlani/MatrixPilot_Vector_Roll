...
//For standard UDB5, put this line in options.h -> #define MINIUDB5 0

//For MINIudb5, put this line in options.h -> #define MINIUDB5 1

//If you leave the line out, the default is standard UDB5.
...
//1 enables gain schedulling for high altitude flights; 0 disables gain schedulling (standard code behaviour)
#define ROLL_GAIN_SCHEDULE 					0
#define PITCH_GAIN_SCHEDULE 				0
#define YAW_GAIN_SCHEDULE 					0
...
//#define CUT_DOWN_CHANNEL_REVERSED
#define CUT_DOWN_INPUT_CHANNEL             CHANNEL_6

//#define PARACHUTE_CHANNEL_REVERSED
#define PARACHUTE_INPUT_CHANNEL             CHANNEL_UNUSED
...
// Set NO_RADIO_JUMPER to 0 if you want the radio failsafe to work in the
// default mode in which a failsafe channel is used to detect loss of signal to the Rx.
// Set NO_RADIO_JUMPER to 1 if you want to use a jumper to control whether or not
// the failsafe channel is used to control failsafe.
// When a jumper is connected between SCL and ground, failsafe is controlled by loss of the failsafe channel in the usual way.
// When the jumper is removed, the state is forced into the failsafe mode and all Rx signals are ignored.
#define NO_RADIO_JUMPER						0
...
#define RTL_PITCH_DOWN_INPUT_CHANNEL	    CHANNEL_5
#define ROLL_OFFSET_INPUT_CHANNEL	        CHANNEL_7    // TODO: ASSIGN CHANNEL
...
#define RTL_PITCH_DOWN_CHANNEL_REVERSED	    0
#define AILERON_SECONDARY_CHANNEL_REVERSED  0
#define THROTTLE_CHANNEL_REVERSED           0
#define CAMERA_PITCH_CHANNEL_REVERSED       0
#define CAMERA_YAW_CHANNEL_REVERSED         0
#define CUT_DOWN_CHANNEL_REVERSED           0
#define PARACHUTE_CHANNEL_REVERSED          0
...
#define FAILSAFE_INPUT_MIN                 	3700
#define FAILSAFE_INPUT_MAX                  4000

// NORMAL RANGE FOR ARDUINO RTL PITCH DOWN INPUT
#define RTL_PITCH_DOWN_INPUT_MIN	    2000
#define RTL_PITCH_DOWN_INPUT_MAX	    4000
...
#define MAXIMUM_LATERAL_ACCELERATION				0.6
#define ROLLKP								0.7   //0.07
#define ROLLKD								0.1   //0.007
//#define YAWKP_AILERON						0.037 // no longer used
#define YAWKD_AILERON						0.1   //0.0037
//#define AILERON_BOOST						0.00  // no longer used
...
#define PITCHGAIN							0.4   //0.04
#define PITCHKD								0.1   //0.004
#define RUDDER_ELEV_MIX						0.0   //0.5
#define ROLL_ELEV_MIX						1.0   //0.55
#define ELEVATOR_BOOST						0.5    //0.8
...
#define YAWKP_RUDDER                        0.05    //0.03125
#define YAWKD_RUDDER                        0.05    //0.25
#define ROLLKP_RUDDER                       0.06    //0.0625
#define ROLLKD_RUDDER                       0.05    //0.025
#define MANUAL_AILERON_RUDDER_MIX           0.00
#define RUDDER_BOOST                        1.00	//0.00
...
#define HEIGHT_TARGET_MIN                   200.0
#define HEIGHT_TARGET_MAX                   800.0
...
// this is the real angle in degrees that the nose of the plane will pitch downward during autonomous (GPS) mode.
// it is used to increase speed (and wind penetration) during GPS mode.
// set it to zero if you do not want to use this feature.
// This only takes effect when not in manual or stabilized mode.
// RTL_PITCH_DOWN is the value used when the Arduino is not sending input
// RTL_PITCH_DOWN_MAXIMUM is the maximum value when the Arduino is setting the value
#define RTL_PITCH_DOWN                      0.0
#define RTL_PITCH_DOWN_MAXIMUM		    30.0
#define	ROLL_OFFSET_MAXIMUM		    30.0
